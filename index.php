...
<body>
    <div class="centered-wrapper">
        <div class="form-container" style="width: 60%; min-height: 90%;">
            ...
            <button type="button" class="btn btn-primary btn-lg" style="margin-top: 20px;" id="add-btn" onclick="showAddTodoDialog()">
                <i class="fa fa-plus"></i> Add New Task
            </button>
            
            <div>
                <button type="button" class="btn btn-danger" style="opacity: 0.8; position: absolute; bottom: 40px; right: 40px;" onclick="window.location.href='logout.php';">
                    Log out
                </button>
            </div>
                            ...
                            <td class="text-center" style="vertical-align: middle;">
                                <ul class="list-inline m-0">
                                    <li class="list-inline-item">
                                        <button onclick="showEditTodoDialog(<?php echo $row['id'];?>, '<?php echo rawurlencode($row['todo']);?>')" name="updt-todo-btn" id="updt-todo-btn" class="btn btn-success btn-sm rounded-1" style="opacity: 0.9;" type="submit" data-toggle="tooltip" data-placement="top" title="Edit">
                                            <i class="fa fa-edit"></i>
                                        </button>
                                    </li>
                                    <li class="list-inline-item">
                                        <form action="index.php?id=<?php echo $row['id'];?>" method="post">
                                            <button name="dlt-todo-btn" id="dlt-todo-btn" class="btn btn-danger btn-sm rounded-1" style="opacity: 0.9;" type="submit" data-toggle="tooltip" data-placement="top" title="Delete">
        ...
        <form class="form modal-content" action="index.php" method="post">
            <div class="form-container" style="backdrop-filter: blur(40px);">
                <div class="input-group mb-3">
                    <input class="shadow-input-wrapped" style="width: 88%;" type="text" id="add-todo" name="add-todo" placeholder="Enter your todo task here..." autocomplete="off">
                    <button class="colored-btn-wrapped" style="width: 12%;" name="add-todo-btn" id="add-todo-btn" type="submit">Add</button>
                </div>
            </div>
        </form>
    </div>
        ...
        <form class="form modal-content" action="index.php" method="post">
            <div class="form-container" style="backdrop-filter: blur(40px);">
                <div class="input-group mb-3">
                    ...
                    <input class="shadow-input-wrapped" style="width: 88%;" type="text" id="edit-todo" name="edit-todo" placeholder="Enter your updated todo task here..." autocomplete="off">
                    <button class="colored-btn-wrapped" style="width: 12%;" name="edit-todo-btn" id="edit-todo-btn" type="submit">Update</button>
                </div>
            </div>
        </form>
    </div>
